    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-100 to-pink-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center">
          <div className="bg-gradient-to-br from-purple-500 to-pink-500 text-white h-12 w-12 rounded-full flex items-center justify-center shadow-lg">
            <Bell className="h-6 w-6" />
          </div>
        </div>
        <h2 className="mt-6 text-center text-3xl font-extrabold bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 bg-clip-text text-transparent">
          NotificApp
        </h2>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-5xl">
        <div className="bg-white bg-opacity-95 py-8 px-4 shadow-2xl sm:rounded-lg sm:px-10 border-t-4 border-gradient-to-r from-purple-500 to-pink-500">
